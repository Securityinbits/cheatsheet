...
@{ Name = ''; Expression = {}}
```
Using E/Expression we are calculating the MD5 & SHA256 of each file returned by Get-ChildItem as shown below in the [gather file hashes](https://github.com/Securityinbits/cheatsheet/new/master#gather-file-hashes) section.
